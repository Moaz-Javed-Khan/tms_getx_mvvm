...
class UpdateRoleController extends GetxController
  ...
  late final UpdateRoleRepository repository;

  UpdateRoleController(this.repository);
  ...
  updateRole(String token, UpdateRoleModelRequest input) async {
    try {
      change(null, status: RxStatus.loading());
      repository.updateRole(token: token, input: input).then((value) {
